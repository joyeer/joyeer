...
// assign expr to an static member, its automatically generated by
struct StaticMemberAssignExpr: Node {
    using Ptr = std::shared_ptr<StaticMemberAssignExpr>;
    
    Node::Ptr owner;
    Node::Ptr staticField;
    Node::Ptr expr;
